...
export const editorProjectUrl = (projectId, v2) => `https://${HOST}/editor/project/${projectId}?${v2 ? 'v2&' : ''}${SEARCH_PARAMS}`;
export const editorSceneUrl = (sceneId, v2) => `https://${HOST}/editor/scene/${sceneId}?${v2 ? 'v2&' : ''}${SEARCH_PARAMS}`;
export const launchSceneUrl = (sceneId, v2) => `https://${LAUNCH_HOST}/${sceneId}?${v2 ? 'v2&' : ''}${SEARCH_PARAMS}`;
